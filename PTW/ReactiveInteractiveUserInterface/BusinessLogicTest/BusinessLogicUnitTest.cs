...
namespace TP.ConcurrentProgramming.BusinessLogic.Test
{
    ...
    public class BusinessLogicImplementationUnitTest
    {
        ...
        {
            DataLayerUpdateSpeedFixcure dataLayerFixcure = new();
            using (BusinessLogicImplementation newInstance = new(dataLayerFixcure))
            {
                double testSpeed = 7.5;
                newInstance.UpdateSpeed(testSpeed);
                Assert.AreEqual(testSpeed, dataLayerFixcure.LastSpeedValue);
            }
        }
        ...
        private class DataLayerUpdateSpeedFixcure : Data.DataAbstractAPI
        {
            internal double LastSpeedValue = 0;
